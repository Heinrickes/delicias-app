...
export function MobileNav() {
  ...
  return (
    <>
      ...
      <div
        className={clsx(
          "fixed inset-x-0 z-40 rounded-t-2xl bg-card px-4 pb-4 pt-3 shadow-2xl ring-1 ring-foreground/10 transition-transform duration-300 ease-out lg:hidden",
        ...
        >
          <div
            className={clsx(
              ...
              open || isSecondaryActive ? "bg-primary/50" : "bg-foreground/20"
            )}
          />
        </button>
